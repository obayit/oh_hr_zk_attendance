...
class HrEmployee(models.Model):
    ...
    def get_time_period(self, datetime_str, tz_offset_number):
        ...
        week_counter = 0
        closest_period = {'value': 99, 'type': False}
        for att_id in attendance_ids.filtered(lambda r: r.dayofweek == str(datetime_date.weekday())):
        ...
        print('# closest period is {} {}'.format(closest_period['type'], closest_period['value']))
